...
if (json_decode($person->getMyPartiQues($conn), true) != null) {
    $data1 = json_decode($person->getMyPartiQues($conn), true);
  ...
  <h2 class='pb-2 text-danger' > Mes Questions </h2 > 
      <div class='row row-cols-4 '>
            ...
            <div class='col-md-1'>
                ...
                <?php
                // Show all questions asked by users
                if (json_decode($person->getMyQuestions($conn), true) != null) {
                    foreach ($index as $v) {
            ...
            <div class='col-md'>
                ...
                ?>
                <h2 class="h2 text-danger border-top pt-2">Participés</h2>
            ...
            <div class='col-md-2'>
                ...
                if ($person->getClass() == 1 or $person->getClass() == 2) {
                    echo "<div class='row pt-2 border-top  border-bottom' id = 'Course'>
